            ...
            if (id) {
                this.messageService.find(id)
                    .subscribe((messageResponse: HttpResponse<MessageMySuffix>) => {
                        ...
                        message.createDate = this.datePipe
                            .transform(message.createDate, 'yyyy-MM-ddTHH:mm:ss');
                        message.updateDate = this.datePipe
                            .transform(message.updateDate, 'yyyy-MM-ddTHH:mm:ss');
