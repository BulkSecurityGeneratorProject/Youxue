...
export class MessageMySuffixService {
    ...
    private convertItemFromServer(message: MessageMySuffix): MessageMySuffix {
        ...
        copy.createDate = this.dateUtils
            .convertDateTimeFromServer(message.createDate);
        copy.updateDate = this.dateUtils
            .convertDateTimeFromServer(message.updateDate);
        return copy;
    }
    ...
    private convert(message: MessageMySuffix): MessageMySuffix {
        ...
        copy.createDate = this.dateUtils.toDate(message.createDate);

        copy.updateDate = this.dateUtils.toDate(message.updateDate);
        return copy;
    }
}
