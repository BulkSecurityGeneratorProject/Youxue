...
describe('Service Tests', () => {
    ...
    describe('TuanMemberMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TuanMemberMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tuan-members';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TuanMemberMySuffix', () => {
