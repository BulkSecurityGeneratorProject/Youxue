...
describe('Service Tests', () => {
    ...
    describe('TuanInfoMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TuanInfoMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tuan-infos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TuanInfoMySuffix', () => {
