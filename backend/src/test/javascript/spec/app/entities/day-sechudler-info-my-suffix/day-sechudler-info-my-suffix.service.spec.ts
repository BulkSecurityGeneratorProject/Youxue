...
describe('Service Tests', () => {
    ...
    describe('DaySechudlerInfoMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DaySechudlerInfoMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/day-sechudler-infos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DaySechudlerInfoMySuffix', () => {
