...
describe('Service Tests', () => {
    ...
    describe('MessageCommentMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MessageCommentMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/message-comments';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MessageCommentMySuffix', () => {
